...
const READING_PATHS = [
  {
    ...
    steps: [
      { label: 'Start here', title: 'We Keep Building AI We Don\'t Understand', href: '/editorial/we-keep-building-ai-we-dont-understand' },
      { label: 'Then read', title: 'The Alignment Problem Is Not What You Think', href: '/editorial/alignment-problem-explained' },
      { label: 'Deep dive', title: 'Is the AI Investment Bubble About to Pop?', href: '/editorial/is-the-ai-investment-bubble-about-to-pop' },
      { label: 'Context', title: 'Open-Source AI Is Winning. Nobody Is Ready.', href: '/editorial/open-source-ai-is-winning-and-nobody-is-ready' },
    ],
  },
  {
    id: 'modern-work',
    ...
    steps: [
      { label: 'Start here', title: 'The Great Unbundling of Work', href: '/editorial/great-unbundling-work' },
      { label: 'Then read', title: 'The End of the Office as Default', href: '/editorial/the-end-of-the-office-as-default' },
      { label: 'Deep dive', title: 'Software Is Still Eating the World', href: '/editorial/software-eating-world-2' },
      { label: 'Context', title: 'The Gig Economy Has Reached an Inflection Point', href: '/editorial/the-gig-economy-has-reached-an-inflection-point' },
    ],
  },
  {
    id: 'health-crisis',
    ...
    steps: [
      { label: 'Start here', title: 'The Sleep Debt Crisis Nobody Is Taking Seriously', href: '/editorial/sleep-debt-crisis' },
      { label: 'Then read', title: 'The Loneliness Epidemic Nobody Wants to Talk About', href: '/editorial/the-loneliness-epidemic-hidden-health-crisis' },
      { label: 'Deep dive', title: 'What Ten Years of Social Media Research Shows About the Brain', href: '/editorial/what-ten-years-of-social-media-research-shows' },
    ],
  },
];
